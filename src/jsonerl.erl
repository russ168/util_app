%% modified json library according to git://github.com/lambder/jsonerl.git
%% use proplist [{k,v},{k,v},...] json object instead of {{k,v},{k,v}, ...}
...
json_encode_proplist([], _State) ->
    <<"{}">>;
json_encode_proplist(Proplist, State) ->
    F = fun ({K, V}, Acc) ->
